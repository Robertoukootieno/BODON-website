...
const testimonials = [
  {
    ...
    rating: 5,
    comment: 'Our Maasai Mara safari with Bodon Tours was absolutely incredible! The guides were knowledgeable, the accommodations were perfect, and we saw the Big Five. Highly recommend!',
  ...
  },
  {
    ...
    rating: 5,
    comment: 'Climbing Mount Kenya was a dream come true. The team at Bodon Tours made sure we were safe and well-prepared. The views from the summit were breathtaking!',
  ...
  },
  {
    ...
    rating: 5,
    comment: 'The cultural tour was amazing! We learned so much about Kenyan traditions and the local communities. The beaches in Diani were paradise. Thank you, Bodon Tours!',
